...
## Project Summary
The project uses a 2 m university bridge instrumented with sensors, likely including strain gauges. Sensor signals are expected to pass through a GSV-8DS signal amplifier into a computer running MATLAB. The MATLAB system should acquire live data, process it, and display a real-time visual representation of the bridge using colour coding.
